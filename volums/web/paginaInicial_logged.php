...
<body>
    ...
    <body>
        ...
        <nav>
            ...
            <a href="paginas/funcionalidad2.php"> Funcion 2</a>
            <a href="paginas/funcionalidad3.php"> Funcion 3</a>
            <a href="paginas/funcionalidad4.php"> Funcion 4</a>
            <a href="paginas/funcionalidad5.php"> Funcion 5</a>
            <a href="paginas/funcionalidad6.php"> Funcion 6</a>
            <a href="paginas/funcionalidad7.php"> Funcion 7</a>
        </nav>
        <main>
            <div class="wrapper">
